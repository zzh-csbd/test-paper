...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('尿液识别系统')  # todo 修改系统名称
        # 模型初始化
        self.model = tf.keras.models.load_model("models/mobilenet_flowers.h5")  # todo 修改模型名称
        self.to_predict_name = "images/huaxue.jpg"  # todo 修改初始图片，这个图片要放在images目录下
        self.class_names = ['10', '100', '20', '30', '40', '50', '60', '70', '80', '90']  # todo 修改类名，这个数组在模型训练的开始会输出
        self.resize(900, 700)
        self.initUI()
    ...
    def initUI(self):
        ...
        about_title = QLabel('欢迎使用识别系统')  # todo 修改欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/bj.jpg'))
        about_img.setAlignment(Qt.AlignCenter)
        label_super = QLabel("作者：zzh")  # todo 更换作者信息
