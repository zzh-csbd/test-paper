...
def data_set_split(src_data_folder, target_data_folder, train_scale=0.7, val_scale=0.3, test_scale=0.0):
    '''
...
if __name__ == '__main__':
    src_data_folder = "D:/dejahu/vegetables_tf2.3-master/data1"   # todo 修改你的原始数据集路径
    target_data_folder = "D:/dejahu/new_data1"  # todo 修改为你要存放的路径
